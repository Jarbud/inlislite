            ...
            <div class="card">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>@if($data->Status == "acc")
                                <span class="badge bg-success">Diterima</span>
                            @elseif($data->Status == "dec")
                                <span class="badge bg-danger">Ditolak</span><br>
                                <a href="javascript:void(0)" id="show-kiadmin" data-url="{{ route('karyailmiahadminshow', $data->id) }}">Lihat Detail</a>
                        ...
                        <td>
                            ...
                            <a class="btn btn-primary" href="{{ route('usermanagement.edit',$data->id) }}">Edit</a>
                            @csrf
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <textarea readonly class="form-control" name="MsgDitolak" id="MsgDitolak" rows="3"></textarea>
        </div>
      </div>
        ...
        /* When click show user */
         $('body').on('click', '#show-kiadmin', function () {
           ...
           $.get(kiadminURL, function (data) {
               ...
               $('#MsgDitolak').val(data.MsgDitolak);
           })
        });
