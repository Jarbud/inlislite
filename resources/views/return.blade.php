        ...
        <div class="container" class="fade-up">
                    ...
                    <div class="tnc">
                        <div class="tnc-content">
                            <div class="tnc-list">
                                <h1>Syarat Peminjaman & Pengembalian Buku</h1>
                                    <ul>
                                        <li>Merupakan mahasiswa aktif</li>
                                        <li>Telah terdaftar sebagai anggota</li>
                                        <li>Memiliki bukti peminjaman</li>
                    ...
                    <div class="return-content">
                        <div class="card flex-row">
                            <div class="card-body">
                                ...
                                <div class="search">    
                                    <div class="row">
                                        <div class="col-8 d-flex align-items-stretch">
                                            <h1><i class="bi bi-card-list"></i>Data Buku Yang Sudah Dikembalikan</h1>
                                        </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr class="table-transaksi">
                                                ...
                                                <!--<td>
                                                    <ul class="list-transaksi">
                                                        <li>Nomor Transaksi<span class="tab"></span>: 0123456789</li>
                                                        <li>Nomor Anggota<span class="tab"></span>: 0123456789</li>
                                                        <li>Nama Anggota<span class="tab"></span>: Aulia Rosa Zahrani</li>
                                                    </ul>
                                                </td>-->
                                                <th scope="row"></th>
                                                <td colspan="1">
                                            ...
                                            <tr class="table-pinjaman">
                                                <th scope="row">4</th>
                                                <td>0123456789</td>
                                                <td>Perpustakaan Tengah Malam</td>
                                                <td>Matt Haig</td>
                                                <td>27-07-2023</td>
                                                <td>27-07-2023</td>
                                                <td>27-07-2023</td>
                                ...
                                <a href="/borrowed" class="btn btn-to-other">Lihat Buku Yang Sedang Dipinjam</a>
                            </div>
                        </div>
                    </div>
