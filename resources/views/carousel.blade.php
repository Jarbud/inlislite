  ...
  <section id="carousel">
    <div class="overlay">
      ...
      <a href="#" class="btn-get-started">Masuk Sekarang</a>
        ...
        <div id="carouselbackground" class="carousel silde carousel-fade" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item carousel-image bg-2 active">
              <img class="d-block w-100" alt="...">
              <!--<div class="carousel-caption">
                <h1>Selamat Datang</h1>
                <h2>di Digital Library Fakultas Ekonomi dan Bisnis<br>Universitas Brawijaya</h2>
                <a href="#" class="btn-get-started" role="button">Masuk Sekarang</a>-->
                <!--<button type="button" class="btn btn-get-started"><a href="">Masuk Sekarang</a></button>-->
              </div>
            </div>
            <div class="carousel-item carousel-image bg-3">
              <img class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item carousel-image bg-4">
              <img class="d-block w-100" alt="...">
            </div>
          </div>
        </div>
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-6">
            <div class="icon-box">
              ...
              <h3><a href="">Koleksi Digital</a></h3>
            </div>
          </div>
          <div class="col-6">
            <div class="icon-box">
